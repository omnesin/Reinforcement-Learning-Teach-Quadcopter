...
class Critic:
    ...
    def build_model(self):
        ...
        net_states = layers.Dense(units=256, kernel_regularizer=regularizers.l2(0.01))(states)
        ...
        net_actions = layers.Dense(units=128, activation='relu', kernel_regularizer=regularizers.l2(0.01))(actions)
